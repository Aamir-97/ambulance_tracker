...
// import 'package:ambulance_tracker/views/driver/car_registration/pages/document_uploaded_page.dart';
// import 'package:ambulance_tracker/views/driver/car_registration/pages/location_page.dart';
// import 'package:ambulance_tracker/views/driver/car_registration/pages/upload_document_page.dart';
// import 'package:ambulance_tracker/views/driver/car_registration/pages/vehical_color_page.dart';
// import 'package:ambulance_tracker/views/driver/car_registration/pages/vehical_make.dart';
import 'package:ambulance_tracker/views/driver/car_registration/pages/vehical_model_page.dart';
// import 'package:ambulance_tracker/views/driver/car_registration/pages/vehical_model_year_page.dart';
import 'package:ambulance_tracker/views/driver/car_registration/pages/vehical_number_page.dart';
// import 'package:ambulance_tracker/views/driver/car_registration/pages/vehical_type_page.dart';
import 'package:ambulance_tracker/views/home.dart';
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          greenIntroWidgetWithoutLogos(title: 'Ambulance Registration',subtitle: 'Complete the process detail'),
