  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const Text('What make of vehicle is it ?',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600,color: Colors.black),),
        ...
        Expanded(
          child: ListView.builder(itemBuilder: (ctx,i){
            return ListTile(
              ...
              trailing: widget.selectedVehical == vehicalMake[i]?const Padding(
