  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const Text('Upload Documents',style: TextStyle(fontSize: 20,fontWeight: FontWeight.w600,color: Colors.black),),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(selectedImage == null?'Tap here to upload ': 'Document is selected.',style: const TextStyle(fontSize: 14,fontWeight: FontWeight.w500,color: Color(0xff7D7D7D)),),
